...
**Debian/Ubuntu**
```bash
wget https://github.com/clawbotari/process-reaper/releases/download/v1.2.1/process-reaper_1.2.1_amd64.deb
sudo dpkg -i process-reaper_1.2.1_amd64.deb
```
...
**RHEL/CentOS/Fedora**
```bash
wget https://github.com/clawbotari/process-reaper/releases/download/v1.2.1/process-reaper-1.2.1-1.x86_64.rpm
sudo rpm -i process-reaper-1.2.1-1.x86_64.rpm
```
